...
Revision ID: 25aed4dd8198
Revises:
Create Date: 2026-04-10 12:06:24.724254
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_recommendations_reco_id"), "recommendations", ["reco_id"], unique=False
    )
